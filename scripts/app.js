...
(function () {
    ...
    const VALIDATION_RULES = {
        ...
        contactNumber: {
            regex: /^\d{3}-\d{3}-\d{4}$/, // Allows exactly 10 digits (like 437-660-9725)
            errorMessage: "Contact Number must be in the format XXX-XXX-XXXX"
        },
        emailAddress: {
    ...
    function DisplayEditPage(){
        ...
        switch (page) {
            ...
            {   // Edit Contact
                ...
                if(editButton){
                    editButton.innerHTML = `<i class="fa-solid fa-id-card m-2"></i>Edit Contact `;
    ...
    function DisplayProducts(){
        console.log('Calling Display Products function...');
    }

    function DisplayServices(){
        console.log('Calling Display Services function...');
    }
                            ...
                            data += `<tr>
                                ...
                                <td class="text-center">
                                    <button value="${key}" class="btn btn-danger btn-sm delete">
                                        <i class="fa-solid fa-xmark m-1"></i>Delete
                                    </button>
                                </td>
                            </tr>`;
                            index++;
